...
voiceoneXV =  \relative c'' {
  ...
  d r r16  fis,[ e fis]  g[ a g e]  fis[ g fis d] |
   e[ fis e d]  cis[ e d c]  d8[ a']  d16[ cis b d] |
   cis[ b a gis]  a8[ e]  fis[\prall e]  a[ e] |
   e[\prall d]  b'[ d,]  d[\prall cis16 b]  cis[ dis e dis] |
   a'[ fis( g  a)]  gis[( ais b  ais)]  e'[( cis d  e)]  dis[( ees fis  eis)] |
...
voicetwoXV =  \relative c {
  ...
  cis r ais r b r g r |
   ...
   b8[ b16 ais]  b8[ g]  d16[ fis e g]  fis8[ fis'] |
  b,1\fermata \bar "|."
}