...
voiceoneIV =  \relative c' {
  ...
  d[ b] cis8.\trill d16 |                      % bar 48
  d[ c! bes! a g f] |                      % bar 49
  bes[ cis, d e f g] |                     % bar 50
  a[ d] f,8 e16.\trill d32 |                       % bar 51
  d4.\fermata \bar "|."                 % bar 52
}


voicetwoIV =  \relative c {
  \key d \minor
  \time 3/8
  \clef alto
