...
voicetwoXIV =  \relative c' {
  \key bes \major
  \time 4/4
  \clef alto

   bes'8[\mordent bes, d f] bes4 r |                 % bar 1
  ...
  r16  f32[ g a g f16]  c'[ a f' c]
   ...
   c[ ees32 f g f ees16]  a[ c,32 bes a bes c16]
     bes[ bes32 c d c bes16]  f'[ d bes' f] |           % bar 16
