...
#(if (not (defined? 'vdaPartOne))
     (ly:parser-define! 'vdaPartOne #{ s1 #}))

#(if (not (defined? 'vdaPartThree))
...
violinI-partIII = \relative c' {
  ...
  e4 r |
  r8 e f g |
  c4-\tutti e d g,~ g8 d' g d e g c,4 ~ |
  c8 g' c e, d4 g,
  R2
